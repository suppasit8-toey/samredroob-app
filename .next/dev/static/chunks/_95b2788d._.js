...
"[project]/src/app/admin/pricing/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PricingPage() {
    ...
    const fetchConfig = async ()=>{
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('pricing_constants').select('*');
            if (error) {
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('pricing_constants').upsert(updates, {
                onConflict: 'key'
            });
            if (error) {
                throw error;
...
_s(PricingPage, "Q1MIrgFwJ3hl5WbIU3jyFoWMGp4=");
_c = PricingPage;
var _c;
...
//# sourceMappingURL=_95b2788d._.js.map